...
find_path(_PYTHON_NUMPY_INCLUDE_DIR arrayobject.h
          "${NUMPY_PATH}/numpy/"
...
if(_PYTHON_NUMPY_INCLUDE_DIR)
    set(PYTHON_NUMPY_FOUND 1 CACHE INTERNAL "Python numpy development package is available")
    get_filename_component(PYTHON_NUMPY_INCLUDE_DIR ${_PYTHON_NUMPY_INCLUDE_DIR} PATH)
endif(_PYTHON_NUMPY_INCLUDE_DIR)
